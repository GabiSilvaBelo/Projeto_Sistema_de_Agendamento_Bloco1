...
public class SistemaDeAgendamentoController implements SistemaDeAgendamentoRepository {
	...
	public void cadastrarPaciente(Paciente paciente) {
		...
		System.out.println("\nO paciente foi criado com o código : " +paciente.getCodigoPaciente());
	}
	...
	public void atualizarCadastro(Paciente paciente) {
		...
		if (buscarCadastro != null) {
			...
			System.out.println("\nO cadastro do paciente com o código "+paciente.getCodigoPaciente()+" foi atualizado com sucesso ! ");
			}
		else 
			
			System.out.println("\nO cadastro do paciente com o código "+paciente.getCodigoPaciente()+ " não foi encontrado !!" );
	}
	...
	public void deletarPaciente(int codigoPaciente) {
		  ...
		  if (paciente != null) {
			 if (ListaPacientes.remove(paciente)==true) 
				 System.out.println("\nO paciente com o código "+codigoPaciente+" foi deletado com sucesso da base de dados ! ");	  
			 
		  }else 
			   System.out.println("\nO paciente com o código "+codigoPaciente+ " nao foi encontrado ! ");
	...
	public void procurarPorCodigoPaciente(int codigoPaciente) {
		...
		if (paciente != null)
		  ...
		  System.out.println("\nO paciente com o código "+codigoPaciente+ " não foi encontrado ! ");
	}
